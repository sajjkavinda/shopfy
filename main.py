...
def changePassword():
    ...
    if request.method == "POST":
        ...
        # Input validation
        if not validate_password(oldPassword) or not validate_password(newPassword):
            return render_template("changePassword.html", error="Weak password. Password must contain at least 8 characters, including at least one uppercase letter, one lowercase letter, and one digit.")
...
def register():
    if request.method == 'POST':
        ...
        if not validate_password(password):
            return render_template("register.html", error="Weak password. Password must contain at least 8 characters, including at least one uppercase letter, one lowercase letter, and one digit.")
...
def validate_password(password):
    # Password must contain at least 8 characters, including one uppercase letter, one lowercase letter, and one digit
    return len(password) >= 12 and any(char.isupper() for char in password) and any(char.islower() for char in password) and any(char.isdigit() for char in password)
